...
/// A simple storage class that handles both standard and secure storage.
class StorageImpl implements LocalStorage {
  ...
  /// Private constructor
  StorageImpl._() : _secureStorage = const FlutterSecureStorage();

  /// Get the singleton instance of Storage
  static Future<StorageImpl> getInstance() async {
    if (_instance == null) {
      _instance = StorageImpl._();
